...
switch($_GET[act]){
  ...
  <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-map-marker'></i><font color='grey'> Tempat Ibadah</font></a> 
          </li>
        </ul></font>
      </div>
...
<div class='row-fluid sortable'>    
        <div class='box span12'>
          <div class='box-header well' data-original-title>
            <h2><i class='icon-map-marker'></i><font color='green'> Tempat Ibadah</font></h2>&nbsp;|&nbsp;
            <a href='?module=tibadah&act=input' type=button class='btn btn-success'><i class='icon-plus-sign icon-white'></i> Add Data</br></a>
            <div class='box-icon'>
          ...
          <th width='18%'><center><i class='icon-flag'></i> Nama Tempat Ibadah</th>
...
"; 
    ...
    while ($r=mysql_fetch_array($tampil)){
       echo "
            <td><center>".$no."</td>
            <td><center>$r[nama_tibadah]</b></font></td>
            <td><center><li class='thumbnail'>
    <a title='$r[foto]' href='img/gallery/tibadah/$r[foto]'><img src='img/gallery/tibadah/$r[foto]' width='140' height='75'></td>
        ...
        echo"
                <td class='center'><center>
                  <a href='?module=dt_tibadah&id=$r[id_tibadah]' class='btn btn-success' href='#'>
                    <i class='icon-zoom-in icon-white'></i>  
                    Detail                                            
                  </a>
                 <a href='?module=tibadah&act=update&id=$r[id_tibadah]' onclick=\"return confirm('Apakah anda yakin ingin mengubah data Tempat Ibadah $r[nama_tibadah]?')\" class='btn btn-warning' href='#'>
                    <i class='icon-edit icon-white'></i>  
                    Edit                                            
                  </a>
                  <a href=$aksi?module=tibadah&act=hapus&id=$r[id_tibadah] onclick=\"return confirm('Apakah anda yakin ingin menghapus Tempat Ibadah $r[nama_tibadah]?')\" class='btn btn-danger' href='#'>
        ...
        <ul class='breadcrumb'>
          <li>
            <a href='index.php?module=' style='text-decoration:none'><i class='icon-home'></i> <font color='black'> Home</font></a> <span class='divider'>/</span>
             ...
             <a href='index.php?module=tibadah' style='text-decoration:none'><li class='active'><i class='icon-map-marker'></i> Tempat Ibadah</font></a> 
      ...
      <div class='row-fluid sortable'>    
        <div class='box span12'>
          <div class='box-header well' data-original-title>
            ...
            <font color='green'> Edit Tempat Ibadah : $t[nama_tibadah]</font></h2>            
            <div class='box-icon'>
              <a href='#' class='btn btn-minimize btn-round'><i class='icon-chevron-up'></i></a>
              <a href='#' class='btn btn-close btn-round'><i class='icon-remove'></i></a>
            </div>
...
<form method=POST enctype='multipart/form-data' action=$aksi?module=tibadah&act=update>
<input type=hidden name=id value=$t[id_tibadah]>
    ...
    <tr><td width='12%'><label class='control-label'> Tempat Ibadah</td><td width='23%'><input type='text' name='nama_tibadah' value='$t[nama_tibadah]' style='width: 220px;' placeholder='Nama Tempat Ibadah'></td>
    ...
    <tr><td>Kategori</td><td><select name='kategori' data-placeholder='$t[kategori]' data-rel='chosen' style='width: 230px;' replace/>
                    <option name='kategori' value=''></option>
                    <optgroup label='Kategori Tempat Ibadah'>
    ...
    <tr><td>Alamat</td><td><textarea type='text' name='alamat' style='width: 220px; height: 130px;' placeholder='Alamat Lokasi Tempat Ibadah'>$t[alamat]</textarea></td></tr>
...
//ketika link hapus di klik
      ...
      <div>
        <ul class='breadcrumb'>
         <li>
          ...
          <li>
            <a href='index.php?module=tibadah' style='text-decoration:none'><li class='active'><i class='icon-map-marker'></i><font color='black'> Tempat Ibadah</font></a> <span class='divider'>/</span>
          </li>
          <li>
            <a style='text-decoration:none'><i class='icon-plus'></i><font color='grey'> Tambah Tempat Ibadah</font></a> 
          </li>
        </ul>
      </div>
      <div class='row-fluid sortable'>    
        <div class='box span12'>
          <div class='box-header well' data-original-title>
            ...
            <h2>
            <a href='index.php?module=tibadah' type=button class='btn btn btn-danger'><i class='icon icon-white icon-arrowreturn-se'></i></a> &nbsp;
            <i class='icon-map-marker'></i><font color='green'> Tambah Tempat Ibadah</font></h2>            
            <div class='box-icon'>
              <a href='#' class='btn btn-minimize btn-round'><i class='icon-chevron-up'></i></a>
              <a href='#' class='btn btn-close btn-round'><i class='icon-remove'></i></a>
            </div>
  ...
  <form method='POST' enctype='multipart/form-data' action=$aksi?module=tibadah&act=input>
  <table  class='table table-striped table-bordered bootstrap-datatable ' width='100%' border='0' align='center' cellpadding='10' cellspacing='10'>
    <tr><td width='12%'><label class='control-label'>Tempat Ibadah</td><td width='23%'><input type='text' name='nama_tibadah' value='$t[nama_tibadah]' style='width: 220px;' placeholder='Nama Tempat Ibadah'></td>
    ...
    <tr><td>Alamat</td><td><textarea type='text' name='alamat' style='width: 220px; height: 130px;' placeholder='Alamat dan Lokasi Tempat Ibadah'>$t[alamat]</textarea></td></tr>
<!--    <tr><td></td><td></td></tr>   --> 
    <tr><td>Foto</td><td ><input type='file' name='fupload' style='width: 220px;'></td></tr>
