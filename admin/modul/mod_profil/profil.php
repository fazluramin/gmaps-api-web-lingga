...
<script>
    ...
    <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-info-sign'></i><font color='grey'> Profil Kabupaten Kampar</font></a> 
          </li>
        </ul></font>
      </div>
      <div class='row-fluid sortable'>    
        <div class='box span12'>
          <div class='box-header well' data-original-title>
            <h2><i class='icon-info-sign'></i><font color='green'> Informasi Profil Kabupaten Kampar</font></h2>
            <div class='box-icon'>
         ...
         <td width='37%'><center>
         <b>Foto Profil Kabupaten Kampar</b>
         <br><br>
