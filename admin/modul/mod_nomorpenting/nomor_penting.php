...
switch($_GET[act]){
  ...
  <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-info-sign'></i><font color='grey'> Nomor Penting</font></a> 
          </li>
        </ul></font>
      </div>
    ...
    echo "
      <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <a style='text-decoration:none'><i class='icon-plus-sign'></i><font color='grey'> Tambah Data</font></a> 
          </li>
        </ul>
      </div>
      <div class='row-fluid sortable'>    
