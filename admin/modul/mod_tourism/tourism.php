...
switch($_GET[act]){
  ...
  <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-map-marker'></i><font color='grey'> Objek Wisata</font></a> 
          </li>
        </ul></font>
      </div>
...
"; 
    ...
    <a title='$r[foto]' href='img/gallery/wisata/$r[foto]'><img src='img/gallery/wisata/$r[foto]' width='140' height='75'></td>
        ...
        echo"
                <td class='center'><center>
                  <a href='?module=dt_tourism&id=$r[id_wisata]' class='btn btn-success' href='#'>
...
$tampil=mysql_fetch_array(mysql_query("select * from tbl_owisata where id_wisata=$_GET[id]"));
}
...
//ketika link hapus di klik
      ...
      <div>
        <ul class='breadcrumb'>
         <li>
          ...
          <li>
            <a style='text-decoration:none'><i class='icon-plus'></i><font color='grey'> Tambah Objek Wisata</font></a> 
          </li>
        </ul>
      </div>
      <div class='row-fluid sortable'>    
  ...
  <table  class='table table-striped table-bordered bootstrap-datatable ' width='100%' border='0' align='center' cellpadding='10' cellspacing='10'>
    ...
    <tr><td>Alamat</td><td><textarea type='text' name='alamat' style='width: 220px; height: 130px;' placeholder='Alamat Lokasi Objek Wisata'>$t[alamat]</textarea></td></tr>
    <tr><td>Fasilitas</td><td>
   <!-- <select data-placeholder='Pilih Kategori Wisata' name='fasilitas'  multiple data-rel='chosen' style='width: 230px; height: 120px;'>
...
<?php
      for ($a=0;$a<count($fasilitas);$a++)
    {  if(!empty($_GET['id_wisata']))
    {  if(is_fasilitas_selected($a,$_GET['id_wisata'])==1)
    {  echo '<option value="'.$a.'"/ selected>'.$fasilitas[$a].'
                 '; }
...
?>
 ...
 <script type="text/javascript"
      src="http://maps.google.com/maps/api/js?libraries=drawing&key=AIzaSyAeXb4mbak7aXoqOOYs8RKk2HNcGQdiZZY"></script>
    <style type="text/css">
...
The following list shows the approximate level of detail you can expect to see at each zoom level:
    ...
    */
    ...
    var kampar = new google.maps.LatLng(0.343629, 101.019780);

    var init_center = kampar;
