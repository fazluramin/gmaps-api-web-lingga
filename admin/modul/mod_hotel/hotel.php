...
switch($_GET[act]){
  ...
  <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-map-marker'></i><font color='grey'> Hotel & Penginapan</font></a> 
          </li>
        </ul></font>
      </div>
      ...
      <div>
        <ul class='breadcrumb'>
         <li>
          ...
          <li>
            <a style='text-decoration:none'><i class='icon-plus'></i><font color='grey'> Tambah  Hotel</font></a> 
          </li>
        </ul>
      </div>
      <div class='row-fluid sortable'>    
