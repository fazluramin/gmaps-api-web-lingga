...
switch($_GET[act]){
  ...
  <div>
        <ul class='breadcrumb'>
          ...
          <li>
            <li class='active'><i class='icon-map-marker'></i><font color='grey'> Tempat Ibadah</font></a> <span class='divider'></span>
          </li>
        </ul></font>
      </div>
      ...
      <div>
        <ul class='breadcrumb'>
         <li>
          ...
          <li>
            <a style='text-decoration:none'><i class='icon-plus'></i><font color='grey'> Tambah Tempat Ibadah</font></a> <span class='divider'></span>
          </li>
        </ul>
      </div>
      <div class='row-fluid sortable'>    
