...
switch($_GET[act]){
  ...
  default:
      ...
      echo "<font color='white' style='font-family: arial' size='2'>
            <font color='black'>
              ...
              <thead>
                <tr height='0'>
          <td colspan='3' height='35'><form method='POST' action=?module=tibadah&act=caridata>
     
     <div class='input-append'>
     
     <input style='width: 81%;' type=text name='cari' placeholder='Cari Tempat Ibadah' list='auto'>
  ...
  echo"</form>
    ...
    while ($r=mysql_fetch_array($tampil)){
       echo "<a href='?module=tibadah&act=info&id=$r[id_tibadah]' type='button' style='width: 92%;' class='btn'>
            <table border='0' style='width: 100%;'>
            <tr>
            <td style='width: 30%;'>
            <img src='../admin/img/gallery/tibadah/$r[foto]' width:'100' height='50'></td>
            <td style='vertical-align: center ; width: 1%;'>
            </a></td>
            <td style='vertical-align: center ; width: 65%; text-align: left'>

            <a style='text-decoration:none' href='?module=tibadah&act=info&id=$r[id_tibadah]'>
...
//ketika link hapus di klik
  ...
  <tr>
    <td colspan='2'>
    <table border='0' width='100%' height='150' background='../admin/img/gallery/tibadah/$t[foto]' style='background-size: 100%'>
    <tr>
    <td width='50%' height='5'>
    <a href='index.php?module=tibadah'><img src='../admin/img/btbacktrans.png' width='35%'></a>
    </td>
     <td>
    </td>
    </tr>
 ...
 <tr>
    ...
    <center>
    <img src='img/icontibadah.png' width='90%' height='90%'>
    </td>
    <td>
    <b><font size='4' >$t[nama_tibadah]</b></font>
    <br>
