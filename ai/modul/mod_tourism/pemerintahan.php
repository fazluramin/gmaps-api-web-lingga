  ...
  default:
      ...
      echo "<font color='white' style='font-family: arial' size='2'>
            <font color='black'>
              ...
              <thead>
                <tr height='0'>
          <td colspan='3' height='35'><form method='POST' action=?module=pemerintahan&act=caridata>
     
     <div class='input-append'>
     
     <input style='width: 81%;' type=text name='cari' placeholder='Cari Tempat puskesmas/ rumah sakit' list='auto'>
     <button type='submit' name='Submit' class='btn'><i class='icon-search'></i></button>
     
     ";
    echo"<datalist id_pemerintahan='auto'>";
     $qry=mysql_query("SELECT * FROM tbl_pemerintahan");
     while ($t=mysql_fetch_array($qry)) {
      echo "<option value='$t[nama_pemerintahan]'></option>";
     }
  echo"</form>
  </td></div></tr>
              </thead>"; 
    ...
    while ($r=mysql_fetch_array($tampil)){
       echo "<a href='?module=pemerintahan&act=info&id=$r[id_pemerintahan]' type='button' style='width: 92%;' class='btn'>
            <table border='0' style='width: 100%;'>
            <tr>
            <td style='width: 30%;'>
            <img src='../admin/img/gallery/pemerintahan/$r[foto]' width:'100' height='50'></td>
            <td style='vertical-align: center ; width: 1%;'>
            </a></td>
            <td style='vertical-align: center ; width: 65%; text-align: left'>

            <a style='text-decoration:none' href='?module=pemerintahan&act=info&id=$r[id_pemerintahan]'>
            <!--href='http://maps.google.com/?q=$r[latitude],$r[longitude]'-->
            <font size='2' color='black'>

            <b>$r[nama_pemerintahan]</b></font>
...
case "caridata":
      $tampil = mysql_query("SELECT * FROM tbl_pemerintahan");
  ...
  //Tampil Data  Beasiswa
     ...
     <input style='width: 81%;' type=text name='cari' placeholder='Cari Tempat pemerintahan' list='auto'>
     <button type='submit' name='Submit' class='btn'><i class='icon-search'></i></button>
  ...
  echo"</form>
   ...
   $tampil=mysql_query("SELECT * FROM tbl_pemerintahan WHERE nama_pemerintahan LIKE '%$_POST[cari]%'");
    $no=1;
    while ($r=mysql_fetch_array($tampil)){
...
//ketika link hapus di klik
  ...
  <tr>
    <td colspan='2'>
    <table border='0' width='100%' height='150' background='../admin/img/gallery/pemerintahan/$t[foto]' style='background-size: 100%'>
    <tr>
    <td width='50%' height='5'>
    <a href='index.php?module=pemerintahan'><img src='../admin/img/btbacktrans.png' width='35%'></a>
    </td>
     <td>
    </td>
    </tr>
 ...
 <tr>
    ...
    <center>
    <img src='img/iconpemerintahan.png' width='90%' height='90%'>
    </td>
    <td>
    <b><font size='4' >$t[nama_pemerintahan]</b></font>
    <br>
